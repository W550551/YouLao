...
export default function YorozuyaCreatorAdvisoryLanding() {
  return (
    <main className="min-h-screen bg-[#FFF3D3] text-[#4A2E1B]">
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl gap-12 py-16 lg:grid-cols-[1.02fr_0.98fr] lg:py-24">
          ...
          >
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              <Button className="h-13 rounded-[1.35rem] border-3 border-[#4A2E1B] bg-[#FF9F2E] px-7 text-base font-black text-white shadow-[5px_5px_0_#4A2E1B] hover:bg-[#FFB24D] hover:translate-y-0.5 hover:shadow-[3px_3px_0_#4A2E1B]" asChild>
                <a href="#join">
                  申请加入 MVP <ArrowRight className="ml-2 h-4 w-4" />
                </a>
              </Button>
              <Button variant="outline" className="h-13 rounded-[1.35rem] border-3 border-[#4A2E1B] bg-white/70 px-7 text-base font-black text-[#4A2E1B] shadow-[5px_5px_0_#4A2E1B] hover:bg-white hover:translate-y-0.5 hover:shadow-[3px_3px_0_#4A2E1B]" asChild>
                <a href="#how-it-works">看看怎么运作</a>
              </Button>
            </div>
          </motion.div>
      ...
      <section className="px-5 py-12 md:px-10 lg:px-16">
        <div className="mx-auto grid max-w-7xl gap-5 md:grid-cols-3">
          <Card className="rounded-[2rem] border-4 border-[#4A2E1B] bg-white/80 text-[#4A2E1B] shadow-[6px_6px_0_#4A2E1B]">
          ...
          <Card className="rounded-[2rem] border-4 border-[#4A2E1B] bg-[#86E3D4] text-[#4A2E1B] shadow-[6px_6px_0_#4A2E1B]">
            <CardContent className="p-6">
          ...
          <Card className="rounded-[2rem] border-4 border-[#4A2E1B] bg-[#FFD36E] text-[#4A2E1B] shadow-[6px_6px_0_#4A2E1B]">
            <CardContent className="p-6">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            {steps.map((step, index) => {
              ...
              return (
                <Card key={step.title} className="rounded-[2rem] border-4 border-[#4A2E1B] bg-white/80 text-[#4A2E1B] shadow-[5px_5px_0_#4A2E1B]">
                  <CardContent className="p-6">
      ...
      <section id="join" className="px-5 pb-24 md:px-10 lg:px-16">
        <div className="mx-auto max-w-4xl rounded-[2.5rem] border-4 border-[#4A2E1B] bg-white/80 p-8 text-center shadow-[8px_8px_0_#4A2E1B] md:p-12">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Button className="h-13 rounded-[1.35rem] border-3 border-[#4A2E1B] bg-[#FF9F2E] px-7 text-base font-black text-white shadow-[5px_5px_0_#4A2E1B] hover:bg-[#FFB24D] hover:translate-y-0.5 hover:shadow-[3px_3px_0_#4A2E1B]" asChild>
              <a href="mailto:hello@yorozuya.example?subject=我想加入有劳 Yorozuya 创作者 MVP">
